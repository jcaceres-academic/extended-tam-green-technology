...
```{r fig.cap='Conceptual and analytical workflow underlying the extended TAM framework.'}
...
```{r fig.cap='Keyword co-occurrence network derived from the 2021–2025 Scopus corpus.'}
...
```{r fig.cap='Extended Technology Acceptance Model integrating behavioural and institutional dimensions.'}
