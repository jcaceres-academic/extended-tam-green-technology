...
- `docs/`  
  Rendered project website (GitHub Pages), including methodological notes and conceptual diagrams.

- `scripts/`  
  Reproducible scripts used for bibliometric mapping and semantic analysis (R, VOSviewer workflows).

- `figures/`  
  Conceptual figures and analytical visualisations used in the article.

- `tables/`  
  Summary tables derived from bibliometric and expert-elicitation procedures.
